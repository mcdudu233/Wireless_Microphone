...
- [Transmitter](https://github.com/mcdudu233/Wireless_Microphone_Transmitter.git) --> 发射器源代码，目前是项目的子模块
- [Receiver](https://github.com/mcdudu233/Wireless_Microphone_Receiver.git) --> 接收器源代码，目前是项目的子模块
...
所有版本都将会发布在 **本项目的** **[Release](https://github.com/mcdudu233/Wireless_Microphone/releases)** 里，子模块的 Release 中不会更新，直接下载即可。
